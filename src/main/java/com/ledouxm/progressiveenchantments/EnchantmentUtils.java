...
import com.ledouxm.progressiveenchantments.init.ModStats.CustomStats;
...
public class EnchantmentUtils {
        ...
        static {
                ...
                bonusEnchantmentsRequirements.put(Enchantments.INFINITY_ARROWS,
                                List.of(Enchantments.PUNCH_ARROWS, Enchantments.POWER_ARROWS,
        ...
        static {
                for (Enchantment enchantment : bonusEnchantmentsRequirements.keySet()) {
                        bonusEnchantmentsConditions.put(enchantment,
                                        enchantments -> containsAllKeys(enchantments,
                                                        bonusEnchantmentsRequirements.get(enchantment)));
                }
        }
        ...
        static {
                ...
                enchantmentRequirements.put(Enchantments.RESPIRATION,
                                stats -> CustomStats.RESPIRATION.getAmount(stats));
                enchantmentRequirements.put(Enchantments.AQUA_AFFINITY,
                                stats -> CustomStats.AQUA_AFFINITY.getAmount(stats));
                enchantmentRequirements.put(Enchantments.FALL_PROTECTION,
                                stats -> CustomStats.FEATHER_FALLING.getAmount(stats));
                enchantmentRequirements.put(Enchantments.DEPTH_STRIDER,
                                stats -> CustomStats.DEPTH_STRIDER.getAmount(stats));
                enchantmentRequirements.put(Enchantments.SOUL_SPEED, stats -> CustomStats.SOUL_SPEED.getAmount(stats));
                enchantmentRequirements.put(Enchantments.FROST_WALKER,
                                stats -> CustomStats.FROST_WALKER.getAmount(stats));
                ...
                enchantmentRequirements.put(Enchantments.FIRE_ASPECT,
                                stats -> CustomStats.FIRE_ASPECT.getAmount(stats));
                enchantmentRequirements.put(Enchantments.SWEEPING_EDGE,
                                stats -> CustomStats.SWEEPING_EDGE.getAmount(stats));
                enchantmentRequirements.put(Enchantments.BLOCK_EFFICIENCY,
                                stats -> CustomStats.EFFICIENCY.getAmount(stats));
                ...
                enchantmentRequirements.put(Enchantments.SWIFT_SNEAK,
                                stats -> CustomStats.SWIFT_SNEAK.getAmount(stats));
                enchantmentRequirements.put(Enchantments.RIPTIDE,
                                stats -> stats.getValue(Stats.ITEM_USED.get(Items.TRIDENT)));
                enchantmentRequirements.put(Enchantments.QUICK_CHARGE,
                                stats -> stats.getValue(Stats.ITEM_USED.get(Items.CROSSBOW)));
                enchantmentRequirements.put(Enchantments.POWER_ARROWS,
                                stats -> stats.getValue(Stats.ITEM_USED.get(Items.BOW)));
