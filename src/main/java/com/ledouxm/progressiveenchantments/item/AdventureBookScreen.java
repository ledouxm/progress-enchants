...
public class AdventureBookScreen extends Screen {
    public static final ResourceLocation TEXTURE = new ResourceLocation(ProgressiveEnchantments.MODID,
    ...
    public AdventureBookScreen(Player player) {
        super(Component.translatable("gui." + ProgressiveEnchantments.MODID + ".adventure_book.title"));
        this.player = player;
    ...
    public void renderItemDescription(@NotNull GuiGraphics graphics, int y, Enchantment enchantment) {
        ...
        MutableComponent text = Component
                .translatable(descriptionId.replace("minecraft", ProgressiveEnchantments.MODID) +
                        ".desc");
